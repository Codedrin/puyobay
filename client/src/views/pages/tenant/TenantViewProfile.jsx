...
const TenantViewProfile = () => {
  ...
  useEffect(() => {
    ...
    const fetchBookings = async () => {
      try {
        const response = await axios.get(`https://puyobay-server.vercel.app/api/users/bookings/${userId}`);
  ...
  const handleCancelBooking = async () => {
    try {
      ...
      await axios.delete(`https://puyobay-server.vercel.app/api/users/cancel-booking/${userId}/${selectedBookingId}`, {
  ...
  const handleUpdateProfile = async (event) => {
    ...
    try {
      ...
      const response = await axios.put(`https://puyobay-server.vercel.app/api/users/profile/update/${userId}`, updatedProfile);

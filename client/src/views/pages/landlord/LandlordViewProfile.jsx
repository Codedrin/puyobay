...
const LandlordViewProfile = () => {
  ...
  useEffect(() => {
    const fetchBookings = async () => {
      try {
        const response = await axios.get(`https://puyobay-server.vercel.app/api/users/bookings/landlord/${userId}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put(`https://puyobay-server.vercel.app/api/users/profile/update/${userId}`, updatedProfile);
